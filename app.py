...
if page == "Home":
    ...
    **Why these values?**
    - Documents are long paragraphs of 400-600 characters
    - 500 chars captures one complete thought with full context
    - 75 chars overlap prevents cutting sentences mid-thought
    - Smaller chunks (200) are too precise and lose context for longer documents
    - Larger chunks (800) include too much unrelated content
    """)
